...
class Tipo(Moneda):
    ...
    def get_nombre_tipo(self):
        return self.nombre_tipo  # Corregido para que devuelva nombre_tipo
...
class Cotizacion:
    ...
    def __str__(self):
        return f"Compra: {self.get_valor_compra()} | Venta: {self.get_valor_venta()} | Fecha Actualizacion: {self.get_fecha_actualizacion()}"
